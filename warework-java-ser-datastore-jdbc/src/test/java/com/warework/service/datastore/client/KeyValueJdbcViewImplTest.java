...
public class KeyValueJdbcViewImplTest extends AbstractSerDatastoreJdbcTestCase {
	...
	public void testGet1() {
		try {
			...
			//
			final KeyValueView view = (KeyValueView) service.getView(CLIENT_JDBC_1, KeyValueJdbcViewImpl.class);
	...
	public void testGet2() {
		try {
			...
			//
			final KeyValueView view = (KeyValueView) service.getView(CLIENT_JDBC_2, KeyValueJdbcViewImpl.class);
	...
	public void testPut2() {
		try {
			...
			//
			final String value1 = (String) view.get("app.name");
			if ((value1 == null) || (!(value1.equals("XYZ")))) {
				fail();
			}
	...
	public void testKeys2A() {
		try {
			...
			//
			final KeyValueView view = (KeyValueView) service.getView(CLIENT_JDBC_4, KeyValueJdbcViewImpl.class);
