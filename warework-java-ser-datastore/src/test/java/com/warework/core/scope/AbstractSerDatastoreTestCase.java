...
public abstract class AbstractSerDatastoreTestCase extends AbstractTestCase {
	...
	//
	protected static final String PROJECT_NAME = "warework-java-ser-datastore";
	 ...
	 *                        <br>
	 */
	protected ScopeFacade createJSON(final String name) throws ScopeException {

		// Create the configuration of the system.
		final Scope config = new Scope(name);

		// Setup the parameters.
		config.setInitParameter(ScopeL1Constants.PARAMETER_CONTEXT_LOADER, AbstractSerDatastoreTestCase.class);
