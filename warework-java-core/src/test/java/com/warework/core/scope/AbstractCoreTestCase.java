...
public abstract class AbstractCoreTestCase extends AbstractTestCase {
	...
	//
	protected static final String PROJECT_NAME = "warework-java-core";
	...
	protected ScopeFacade createJSON(final String name) throws ScopeException {
		...
		config.setInitParameter(ScopeL1Constants.PARAMETER_CONTEXT_LOADER, AbstractCoreTestCase.class);
