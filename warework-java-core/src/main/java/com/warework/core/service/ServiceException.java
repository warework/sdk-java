...
/**
 * Thrown when a service encounters a problem during the execution of an
 * operation.
 * 
...
public class ServiceException extends AbstractL1Exception {
	...
	// Serialization ID.
	private static final long serialVersionUID = -3216241650172200328L;
	 ...
	 *                        <br>
	 */
	public ServiceException(final ScopeFacade scope, final String errorMessage, final Throwable sourceException,
			final int logLevel) {
	 ...
	 *                  <br>
	 */
	public ServiceException(final AbstractL1Exception exception) {
		super(exception);
	}
