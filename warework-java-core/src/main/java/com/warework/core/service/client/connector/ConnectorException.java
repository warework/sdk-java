...
/**
 * Thrown when a Connector encounters a problem during initialization or the
...
public class ConnectorException extends AbstractL1Exception {
	...
	// Serialization ID.
	private static final long serialVersionUID = -5773732858107554936L;
	 ...
	 *                        <br>
	 */
	public ConnectorException(final ScopeFacade scope, final String errorMessage, final Throwable sourceException,
			final int logLevel) {
	 ...
	 *                  <br>
	 */
	public ConnectorException(final AbstractL1Exception exception) {
		super(exception);
	}
