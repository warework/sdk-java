...
public final class TwitterConnection {
	...
	//
	private TwitterRateController controller;
	 ...
	 *                          <br>
	 * @param consumerKey       Twitter connection consumer key.<br>
	 *                          <br>
	 * @param consumerSecret    Twitter connection consumer secret.<br>
	 *                          <br>
	 * @param accessToken       Twitter connection access token.<br>
	 *                          <br>
	 * @param accessTokenSecret Twitter connection access token secret.<br>
	 *                          <br>
	 * @throws ApiException
	 */
	public TwitterConnection(final ScopeFacade scope, final String consumerKey, final String consumerSecret,
	...
	public TwitterConnection(final ScopeFacade scope, final String consumerKey, final String consumerSecret,
		...
		//
		controller = new TwitterRateController(scope, handler, timeFrame);

		//
		cache = new TwitterCache(controller);
	...
	public ApiRate getAPIRate(final TwitterOperation operationType) {
		return controller.getApiRate(operationType);
	}
	...
	private TwitterDelegate getTwitterDelegate() {
		...
		//
		if ((System.currentTimeMillis() - updated) >= TwitterConstants.CACHE_DEFAULT_LIFETIME_HELPER) {
