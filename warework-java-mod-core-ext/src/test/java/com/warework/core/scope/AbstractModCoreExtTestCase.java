...
public abstract class AbstractModCoreExtTestCase extends AbstractTestCase {
	...
	//
	protected static final String PROJECT_NAME = "warework-java-mod-core-ext";
	...
	protected ScopeFacade createSER(final String name) throws ScopeException {
		...
		config.setInitParameter(ScopeL1Constants.PARAMETER_CONTEXT_LOADER, AbstractModCoreExtTestCase.class);
		config.setInitParameter(ScopeL1Constants.PARAMETER_CONFIG_TARGET,
				AbstractModCoreExtTestCase.class.getResource(ResourceL1Helper.DIRECTORY_SEPARATOR
						+ ResourceL2Helper.DIRECTORY_META_INF + ResourceL1Helper.DIRECTORY_SEPARATOR + PROJECT_NAME
						+ ResourceL1Helper.DIRECTORY_SEPARATOR + name + ResourceL1Helper.FILE_EXTENSION_SEPARATOR
	 ...
	 * Creates a Scope in this context.
	 * 
	 * @param name XML file name. This is also the name of the Scope.<br>
	 *             <br>
	 * @return A new instance of a Scope. If a Scope of the same name is already
	 *         bound to the context, the existing Scope is returned.<br>
	 *         <br>
	 ...
	 *                        <br>
	 */
	protected ScopeFacade createXML(final String name) throws ScopeException {
