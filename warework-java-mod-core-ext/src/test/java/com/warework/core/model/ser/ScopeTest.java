 ...
 */
public class ScopeTest extends AbstractModCoreExtTestCase {
	...
	public void testSetParent1() {
		...
		try {
			...
			//
			color = (String) system.getParent().getInitParameter("color");
	...
	public void testSetContextScope1() {
		...
		//
		if ((config.getContextScope("context-scope-1") == null)
				|| (config.getContextScope("context-scope-1").getInitParameter("color") == null)
				|| (!(config.getContextScope("context-scope-1").getInitParameter("color") instanceof String))
				|| (!((String) config.getContextScope("context-scope-1").getInitParameter("color")).equals("blue"))) {
			fail();
		}

		//
		if ((config.getContextScope("context-scope-2") == null)
				|| (config.getContextScope("context-scope-2").getInitParameter("color") == null)
				|| (!(config.getContextScope("context-scope-2").getInitParameter("color") instanceof String))
				|| (!((String) config.getContextScope("context-scope-2").getInitParameter("color")).equals("red"))) {
			fail();
		}
	...
	public void testGetProvider2() {
		...
		try {
			...
			//
			com.warework.core.model.Provider p = config.getProvider("s");
	...
	public void testGetProvider3() {
		...
		try {
			...
			//
			com.warework.core.model.Provider p = config.getProvider(null);
	...
	public void testGetProviderNames4() {
		try {
			final Enumeration<String> names = new Scope("test").getProviderNames();
			if (names != null) {
				fail();
			}
		} catch (final Exception e) {
	...
	public void testSetService3() {
		try {
			new Scope("test").setService("p", LogServiceImpl.class, null, null);
		} catch (final Exception e) {
			fail();
		}
	}
	...
	public void testGetService2() {
		try {
			...
			//
			com.warework.core.model.Service service = config.getService("p");
			if (service == null) {
				fail();
			}
	...
	public void testGetService3() {
		try {
			...
			//
			com.warework.core.model.Service service = config.getService(null);
			if (service != null) {
				fail();
			}
	...
	public void testGetService4() {
		try {
			...
			//
			com.warework.core.model.Service service = config.getService("s");
			if (service != null) {
				fail();
			}
	...
	public void testGetObject2() {
		try {
			...
			//
			com.warework.core.model.ObjectReference p = config.getObjectReference("o");
	...
	public void testGetObject3() {
		try {
			...
			//
			com.warework.core.model.ObjectReference p = config.getObjectReference(null);
	...
	public void testGetObject4() {
		try {
			...
			//
			com.warework.core.model.ObjectReference p = config.getObjectReference("s");
